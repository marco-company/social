...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-mail_activity_filter_internal_user>=16.0dev,<16.1dev',
        'odoo-addon-mail_activity_meeting_reminder>=16.0dev,<16.1dev',
        ...
        'odoo-addon-mail_autogenerated_header>=16.0dev,<16.1dev',
        ...
        'odoo-addon-mail_message_search>=16.0dev,<16.1dev',
        ...
        'odoo-addon-mail_restrict_send_button>=16.0dev,<16.1dev',
        ...
        'odoo-addon-mass_mailing_disable_tracking>=16.0dev,<16.1dev',
        'odoo-addon-mass_mailing_event_registration_exclude>=16.0dev,<16.1dev',
        'odoo-addon-mass_mailing_list_dynamic>=16.0dev,<16.1dev',
        'odoo-addon-mass_mailing_list_prune_blacklisted>=16.0dev,<16.1dev',
